...
<head>
    ...
    <link rel="stylesheet" href="<?php base_url()?>/assets-landing/dist/css/style.css">
...
<body class="is-boxed has-animations">
								...
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="<?= base_url("uploads/$ts[image]");?>" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0"><?= $ts['deskripsi'];?></p>
										</div>
									</div>
									<div class="testimonial-footer">
										<div class="testimonial-link">
											<a href="#"><?= $ts['username'];?></a>
										</div>
									</div>
								</div>
							</div>
    ...
    <script src="<?php base_url()?>/assets-landing/dist/js/main.min.js"></script>
</body>
</html>
